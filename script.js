...
const menuCategories = [
    {
        ...
        products: [
            { id: 'p1', title: 'Champaran Mutton Handi', image: 'images/mutton_handi.png', options: [ { weight: '1kg', price: 2000 }, { weight: '500gm', price: 1000 }, { weight: '250gm', price: 550 } ] },
            { id: 'p2', title: 'Champaran Chicken Handi', image: 'images/chicken_handi.png', options: [ { weight: '1kg', price: 1000 }, { weight: '500gm', price: 500 }, { weight: '250gm', price: 300 } ] },
            { id: 'p5', title: 'Champaran Egg Curry Handi', image: 'images/egg_handi.png', options: [ { weight: '3 Eggs', price: 200 } ] }
        ]
    },
    {
        categoryId: 'seafood-specials',
        title: 'Champaran Sea Food Specials',
        products: [
            { id: 'sf1', title: 'Champaran Surmai Machhli Curry', image: 'images/surmai_machhli_curry.png', options: [ { weight: '250g', price: 425 } ] },
            { id: 'sf2', title: 'Champaran Rohu Machhli Curry', image: 'images/rohu_machhli_curry.png', options: [ { weight: '250g', price: 450 } ] },
            { id: 'sf3', title: 'Champaran Prawns Curry', image: 'images/prawns_curry.png', options: [ { weight: '15 pcs', price: 550 } ] }
        ]
    },
    {
        categoryId: 'veg-main-course',
        title: 'Veg Main Course',
        products: [
            { id: 'vm1', title: 'Paneer Tikka Masala', image: 'images/paneer_tikka_masala.png', options: [ { weight: 'Full', price: 300 } ] },
            { id: 'vm2', title: 'Dal Tadka / Fry', image: 'images/dal_tadka.png', options: [ { weight: 'Full', price: 180 } ] }
        ]
    },
    {
        categoryId: 'thali',
        ...
        subCategories: [
            {
                ...
                products: [
                    ...
                    { id: 's2', title: 'Masala Prawns Fry', image: 'images/masala_prawns_1774339519962.png', description: 'Crispy fried prawns coated in spicy masala, served with onion rings and lemon.', options: [ { weight: '15 pcs', price: 500 } ] },
                    { id: 's4_1', title: 'Champaran Surmai Machhli (Dry)', image: 'images/surmai_machhli_dry.png', description: 'Spicy, crispy dry fried fish pieces. Served rustic style.', options: [ { weight: '250g', price: 375 } ] },
                    { id: 's4_2', title: 'Champaran Rohu Machhli (Dry)', image: 'images/rohu_machhli_dry.png', description: 'Deep-fried spicy dry fish. Rustic authentic preparation.', options: [ { weight: '250g', price: 400 } ] },
                    { id: 's4_3', title: 'Champaran Masala Eggs (Dry)', image: 'images/masala_eggs_dry.png', description: 'Boiled eggs coated in thick, spicy, dry masala.', options: [ { weight: '3 pcs', price: 150 } ] },
    ...
    },
    {
        ...
        products: [
            { id: 'sd1', title: 'Plain Rice', image: 'images/plain_rice_1774339658813.png', options: [ { weight: 'Full', price: 120 } ] },
            { id: 'sd2', title: 'Ghee Rice', image: 'images/ghee_rice.png', options: [ { weight: 'Full', price: 150 } ] },
            { id: 'sd2_j', title: 'Jeera Rice', image: 'images/jeera_rice.png', options: [ { weight: 'Full', price: 150 } ] },
            { id: 'sd3', title: 'Sattu Paratha', image: 'images/sattu_paratha.jpg', options: [ { weight: '1 pc', price: 70 } ] },
            { id: 'sd4', title: 'Plain Ghee Paratha', image: 'images/ghee_paratha.jpg', options: [ { weight: '1 pc', price: 50 } ] },
            { id: 'sd3_a', title: 'Aloo Paratha', image: 'images/aloo_paratha.png', options: [ { weight: '1 pc', price: 70 } ] },
            { id: 'sd5', title: 'Tawa Roti', image: 'images/chapati.jpg', options: [ { weight: '1 pc', price: 20 } ] },
            { id: 'sd6', title: 'Ghee Roti', image: 'images/ghee_chapati.jpg', options: [ { weight: '1 pc', price: 30 } ] },
            { id: 'sd7', title: 'Litti', image: 'images/litti.jpg', options: [ { weight: '1 pc', price: 40 } ] }
        ]
    },
    {
...
checkoutForm.addEventListener('submit', function(e) {
    ...
    msg += `I understand that I am liable to pay packing & forwarding charges of ₹30 per parcel and ₹60 for mud pot (handi).
Kindly send your QR Scanner too for payments as confirmation of our order.
We also agree to pay porter charges or delivery charges as per actuals.
